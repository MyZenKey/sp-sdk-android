...
/**
 * A contract for [IDiscoveryCallFactory]
 */
internal interface IDiscoveryCallFactory {
     ...
     * @return a [HttpCall] for a [DiscoveryResponse]
     */
    fun create(mcc_mnc: String?, prompt: Boolean): HttpCall<DiscoveryResponse>
}
