...
internal val Context.clientIdMetadataKey: String
    get() {
        return getString(R.string.zenkey_client_id)
    }

internal val Context.metadata: Bundle?
    get() {
        return packageManager.metadata(packageName)
    }

internal val Context.clientId: String
    get() {
        return metadata?.getString(clientIdMetadataKey) ?: ""
    }